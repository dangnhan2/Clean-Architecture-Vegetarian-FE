      ...
      <Card className="border border-gray-200 bg-white">
        ...
        <CardContent className="space-y-6">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-200 bg-white py-12 text-center text-sm text-gray-500">
              <MessageSquare className="mb-3 h-6 w-6 text-gray-400" />
